...
export default function PaymentPage() {
  ...
  // ITO YUNG BAGONG FUNCTION PARA I-VALIDATE ANG FILE
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // ITO YUNG BAGONG PARAAN: I-SEND NATIN SA SERVER-SIDE API
      ...
      <div className="mx-auto max-w-xl">
        ...
        <div className="rounded-2xl bg-white p-8 shadow-lg">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-gray-600">Complete your payment to unlock your ID</p>
          </div>
          <div className="mb-8 rounded-xl bg-blue-50 p-6 text-center shadow-sm">
            ...
            <p className="mt-2 text-2xl font-bold text-blue-700">09127808628</p>
            <p className="mt-2 text-sm text-blue-600">Account Name: <span className="font-semibold">Aljun Fenis</span></p>
            <img
              src="/gcash-qr.png"
              alt="GCash QR Code"
              style={{
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="mb-2 block font-semibold text-gray-700">Amount (PHP)</label>
              <input
                type="number"
                value={amount}
            ...
            <div>
              <label className="mb-2 block font-semibold text-gray-700">Payment Method</label>
              <select
                value={paymentMethod}
            ...
            <div>
              <label className="mb-2 block font-semibold text-gray-700">Proof of Payment (Screenshot)</label>
              <input
                type="file"
                accept="image/*"
            ...
            {error && (
              <div className="rounded-lg bg-red-100 p-4 text-sm text-red-700">{error}</div>
            )}
            {message && (
              <div className="rounded-lg bg-green-100 p-4 text-sm text-green-700">{message}</div>
            )}
            <button
              type="submit"
              disabled={loading}
